...
$user = array(
    'USER_LOGIN' => 'im@nowmedia.ru', #Ваш логин (электронная почта)
    'USER_HASH' => '26d6267bb25fdb76b0d6a6a41b01c317', #Хэш для доступа к API (смотрите в профиле пользователя)
);
$subdomain = 'nowmd'; #Наш аккаунт - поддомен
...
return 'Авторизация не удалась';#Массив с параметрами, которые нужно передать методом POST к API системы
