...
<div class="bg-color-sky-light">
    <div class="content-md container">
        <img class="img-responsive" src="local/templates/main/assets/HTML/img/1920x1080/02.jpg" alt="Slider Image">
    </div>
</div>
<!-- End Slider -->
...
<div class="content-md container">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-sm-offset-1">
            <img class="img-responsive" src="local/templates/main/assets/HTML/img/640x380/01.jpg" alt="Our Office">
        </div>
    </div>
    <!--// end row -->
</div>
        ...
        <div class="swiper-slider swiper-clients">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="local/templates/main/assets/HTML/img/clients/01.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="local/templates/main/assets/HTML/img/clients/02.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="local/templates/main/assets/HTML/img/clients/03.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="local/templates/main/assets/HTML/img/clients/04.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="local/templates/main/assets/HTML/img/clients/05.png" alt="Clients Logo">
                </div>
                <div class="swiper-slide">
                    <img class="swiper-clients-img" src="local/templates/main/assets/HTML/img/clients/06.png" alt="Clients Logo">
                </div>
            </div>
            <!-- End Swiper Wrapper -->
        </div>
